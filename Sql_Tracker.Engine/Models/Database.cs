...
namespace Sql_Tracker.Engine.Models
{
    public class Database : IModel
    {
        ...
        public string GetAll()
        {
            ...
            Sql += "FROM [dbo].[tblDatabases] WITH(NOLOCK) " + Environment.NewLine;
        ...
        public string GetObjectsSql()
        {
            return "SELECT @ServerGUID as ServerGUID, " +
                ...
                "db.[Name], " +
                "0 as [IsDeleted], " +
                "db.create_date as DateCreated, " +
                "db.create_date as DateModified " +
        ...
        public string[] GetPostUpsertSql()
        {
            ...
            // Populate Server to Database Relation
        ...
        public string GetUpsertSql()
        {
            ...
            Sql += "INNER JOIN @inputTable as tS ON tD.[ServerGUID] = tS.[ServerGUID] AND tD.[Name] = tS.[Name] " + Environment.NewLine;
            Sql += "; " + Environment.NewLine;
            Sql += "INSERT INTO [dbo].[tblDatabases] ( " + Environment.NewLine;
            Sql += "[ServerGUID], [Name], [IsDeleted], [DateCreated], [DateModified] " + Environment.NewLine;
            Sql += ")  " + Environment.NewLine;
            Sql += "SELECT [tS].[ServerGUID], [tS].[Name], [tS].[IsDeleted], [tS].[DateCreated], [tS].[DateModified] " + Environment.NewLine;
